...
component: true
links:
  doc: https://docs.availproject.org/nexus/avail-nexus-sdk/nexus-core/bridge-methods/bridge
...
<CodeTabs>
  ...
  <TabsContent value="cli">
    ```bash
    npx shadcn@latest add https://develop.elements.nexus.availproject.org/r/fast-bridge.json
    ```
  </TabsContent>
