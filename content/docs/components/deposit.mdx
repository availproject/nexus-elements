...
```bash
npm install @avail-project/nexus-core@1.0.0-beta.32 lucide-react @radix-ui/react-tabs @radix-ui/react-dialog @radix-ui/react-accordion @radix-ui/react-label @radix-ui/react-popover @radix-ui/react-checkbox @radix-ui/react-slot
```
