...
> **Deprecated:** This standalone Deposit element is deprecated in favor of [Nexus One](/docs/components/nexus-one). For new integrations, use `NexusOne` with `config={{ mode: "deposit", opportunities: [...] }}`.
