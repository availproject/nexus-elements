...
<ComponentPreview
  name="new-deposit"
  description="Deposit final bridgeable assets into a destination with source breakdown, allowance flow, and optional embedded card view. Intent-based and customizable execute builder."
  align="center"
