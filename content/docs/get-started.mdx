...
<Steps>
  ...
  <div className="leading-relaxed not-first:mt-6">
  ...
  <div className="leading-relaxed not-first:mt-6">Once installed, come back to continue with Nexus Elements.</div>
...
<div className="mt-3! leading-relaxed not-first:mt-6">
