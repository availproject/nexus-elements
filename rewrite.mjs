import fs from 'fs';
let content = fs.readFileSync('registry/avail-widgets/nexus-one/nexus-one.tsx', 'utf8');
...
fs.writeFileSync('registry/avail-widgets/nexus-one/nexus-one.tsx', content);
