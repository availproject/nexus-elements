...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "connect-src 'self' https://api.coinbase.com https://rpcs.avail.so https://*.avail.so wss://*.avail.so ws://*.avail.so https://*.walletconnect.com https://*.walletconnect.org wss://*.walletconnect.com wss://*.walletconnect.org https://*.infura.io https://*.alchemy.com https://mainnet.infura.io https://polygon-rpc.com https://api.avax.network https://rpc.ankr.com https://*.ankr.com https://*.1inch.io https://*.1inch.exchange https://*.uniswap.org https://*.uniswap.io https://monadvision.com https://*.merkle.io https://*.arcana.network http://*.arcana.network https://cosmos01-testnet.arcana.network:26650 http://cosmos01-testnet.arcana.network:26650 https://cosmos04-dev.arcana.network http://cosmos04-dev.arcana.network https://cosmos04-dev.arcana.network:26650 http://cosmos04-dev.arcana.network:26650 wss://*.arcana.network ws://*.arcana.network wss://cosmos01-testnet.arcana.network:26650 ws://cosmos01-testnet.arcana.network:26650 wss://cosmos04-dev.arcana.network:26650 ws://cosmos04-dev.arcana.network:26650 https://li.quest https://*.li.quest https://api.bebop.xyz https://*.bebop.xyz https://mainnet.base.org https://*.base.org https://*.optimism.io https://mainnet.optimism.io https://*.arbitrum.io https://arb1.arbitrum.io https://*.scroll.io https://rpc.scroll.io https://*.polygon.technology https://*.avax.network https://*.sophon.xyz https://rpc.sophon.xyz https://*.kaia.io https://public-en.node.kaia.io https://*.bsc.com https://bsc-dataseed.binance.org https://*.binance.org https://*.tron.network https://*.trongrid.io https://*.sepolia.io https://sepolia.infura.io https://rpc.sepolia.org https://sepolia.optimism.io https://*.optimism-sepolia.io https://sepolia-rollup.arbitrum.io https://*.arbitrum-sepolia.io https://*.amoy.polygon.technology https://rpc-amoy.polygon.technology https://sepolia.base.org https://*.base-sepolia.org https://*.monad.xyz https://*.reown.com https://api.reown.com https://*.web3modal.org https://api.web3modal.org *.availproject.org https://*.availproject.org:26650 wss://*.availproject.org",
